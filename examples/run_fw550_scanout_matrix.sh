...
VULKAN_PS5_QUALIFICATION_PASS_PATTERN='^scanout_matrix: PASS cases=A,B,C,D,E exact-readback$' \
VULKAN_PS5_QUALIFICATION_PASS_DESCRIPTION='five exact scanout readback cases' \
