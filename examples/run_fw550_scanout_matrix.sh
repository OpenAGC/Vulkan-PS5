...
VULKAN_PS5_QUALIFICATION_PASS_PATTERN='^scanout_matrix: PASS cases=A,B,C,D,E,F,G,H exact-readback$' \
VULKAN_PS5_QUALIFICATION_PASS_DESCRIPTION='eight exact scanout readback cases' \
